...
TELEGRAM_TOKEN = os.getenv("8966792559:AAF5GIhI9WkL6SL1nX1_NE8_pIBdPADDRRU")
CHAT_ID = os.getenv("1490359174")
...
def send_telegram(message):
    url = f"https://api.telegram.org/bot{8966792559:AAF5GIhI9WkL6SL1nX1_NE8_pIBdPADDRRU}/sendMessage"
